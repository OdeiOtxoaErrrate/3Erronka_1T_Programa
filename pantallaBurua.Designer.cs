namespace erronka3_1T
{
    partial class pantallaBurua
    {
        ...
        private void InitializeComponent()
        {
            ...
            button4 = new Button();
            button3 = new Button();
            b_ezab_btn = new Button();
            bezero_id = new TextBox();
            label9 = new Label();
            button1 = new Button();
            ...
            Controls.Add(b_ezab_btn);
            Controls.Add(bezero_id);
            Controls.Add(label9);
        ...
        private Button b_ezab_btn;
        private TextBox bezero_id;
